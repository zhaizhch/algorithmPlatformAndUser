...
@RestController
@RequestMapping("/algoPlatform/user")
public class UserController {
    ...
    @PostMapping(value = "/_resetPassword")
    ...
    public RestfulEntity<JSONObject> userCheck(
        ...
        return RestfulEntity.getSuccess(result, "token有效");
    }
}
